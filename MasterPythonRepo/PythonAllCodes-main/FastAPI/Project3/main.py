...
def get_database_url():
    ...
    print("⚠️  MySQL connection failed, falling back to SQLite for testing")
    return "sqlite:///./university_portal.db"
...
def create_database_if_not_exists():
    ...
    if not IS_MYSQL:
        print("📝 Using SQLite database - no need to create database")
        return
    ...
    try:
        ...
        if "Unknown database" in str(e) or "database doesn't exist" in str(e):
            ...
            print(f"⚠️  Database connection issue (continuing anyway): {str(e)[:100]}")
...
def read_root():
    ...
    return {"message": "Welcome to University Portal API", "database": db_type}
